...
void MainWindow::buildUi()
{
    ...
    connect(examSelectPage_, &ExamSelectWindow::personalVariantChosen, this,
...
QWidget* MainWindow::buildHomePage()
{
    ...
    auto* btnProgress = makeTile(
        ...
        QString::fromUtf8("Статистика по номерам, темам и динамика.")
        );
    ...
    connect(btnTraining, &QPushButton::clicked, this, [this]{
        QMessageBox::information(this, "Тренировка", "Дальше сделаем страницу тренировки.");
    });
    ...
    connect(btnSettings, &QPushButton::clicked, this, [this]{
        QMessageBox::information(this, "Настройки", "Дальше сделаем страницу настроек.");
    });

    auto* footerLeft = new QLabel(QString::fromUtf8("© Физтех-лицей, 2025"), page);
...
{
    progressPage_->reload(); // чтобы всегда обновлялось
